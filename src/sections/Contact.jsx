...
import Astra from "../assets/contact.png";
        ...
        <motion.div className="w-full md:w-1/2 bg-white/5 p-8 rounded-2xl shadow-lg border border-white/10" initial={{opacity:0 , x:50}} whileInView={{opacity:1 , x:0}} transition={{duration:0.6}}>
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              ...
              {errors.idea && <p className="text-red-500 text-xs">{errors.email}</p>}
            </div>
            ...
            <motion.button className="bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white rounded-md py-3 font-semibold transition" whileHover={{scale: 1.05}} whileTap={{scale: 0.95}} disabled={status === "sending"} type="submit">
